...
static BOOL const kAwesomeMenuDefaultIsPlayingEndAnimation = YES;
...
- (id)initWithFrame:(CGRect)frame startItem:(AwesomeMenuItem*)startItem optionMenus:(NSArray *)aMenusArray
{
    ...
    if (self) {
        ...
        self.isPlayingEndAnimation = kAwesomeMenuDefaultIsPlayingEndAnimation;
